...
<body <?php body_class($body_classes); ?>>
	...
	<div id="page" class="site" data-barba="wrapper">
		<a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e('Skip to content', 'vite-starter'); ?></a>

		<header id="masthead" class="site-header container">
			<div class="site-branding">

				<h1 class="site-title is-theme-primary"><a href="<?php echo esc_url(home_url('/')); ?>" rel="home">
						<?= get_template_part(
				...
				<p class="site-title is-theme-secondary"><a href="<?php echo esc_url(home_url('/')); ?>" rel="home">
						<?= get_template_part(
							'template-parts/atom-logo',
							null,
							array(
				...
				<p class="site-title is-theme-white"><a href="<?php echo esc_url(home_url('/')); ?>" rel="home">
						<?= get_template_part(
							'template-parts/atom-logo',
							null,
							array(
			...
			<div class="nav-container">
				<a href="<?= "/kontakt/" ?>" class="button header-cta show-for-phone" aria-controls="header-cta" aria-expanded="false"><?php esc_html_e('Angebot Anfragen', 'vite-starter'); ?></a>
				<button id="primary-menu-toggle" class="menu-toggle" aria-controls="primary-menu" aria-expanded="false">
					<svg class="open" width="1.8em" height="1.1em" viewBox="0 0 50 26" fill="none" xmlns="http://www.w3.org/2000/svg">
					...
					<svg class="closed" width="1.8em" height="1.1em" viewBox="0 0 49 24" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<button id="primary-menu-toggle" class="menu-toggle menu-toggle--closed" aria-controls="primary-menu" aria-expanded="false">
					<svg width="1.8em" height="1.1em" viewBox="0 0 50 26" fill="none" xmlns="http://www.w3.org/2000/svg">
						<rect x="2" y="0.398804" width="53" height="4" rx="2" transform="rotate(25 2 0.398804)" fill="black" />
						<rect y="22.3988" width="53" height="4" rx="2" transform="rotate(-25 0 22.3988)" fill="black" />
					</svg></button>
				<nav id="site-navigation" class="main-navigation module-palette-primary block-theme">
					<?= get_template_part(
